 ...
 */
package com.developer.SpringMySQL.tools;
...
//        String mailTo = "jafarshodiq0412@gmail.com";
        ...
        String message = "<html>\n"
                ...
                + "                                    </p>\n"
                + "                                    <center>\n"
                + "<a href='http://localhost:8080/user/verification/" + username + "'>Verification</a>"
                //                + "<a href='http://172.20.10.12:8080/user/verification/" + username + "'>Verification</a>"
                + "                                    </center>\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                        </table>\n"
    ...
    public void sendNotification(String to, String username, String job_title, String notification) {
        // SMTP server information
        String host = "smtp.gmail.com";
        String port = "587";
        String mailFrom = "bootcamp32java@gmail.com";
...
//        String mailTo = "jafarshodiq0412@gmail.com";
        String mailTo = to;
        String subject = "Notification Job Apply";
        ...
        String message = "<html>\n"
                ...
                + "                                    <p align=\"center\">\n"
                + "                                        Dear " + username + ",\n "
                + "                                        Thank you for your interesting to apply job " + job_title + " in Our vacancy \n"
                + "                                        "+ notification + " <br>\n"
                + "                                    </p>\n"
                + "                                    <center>\n"
//                + "<a href='http://localhost:8080/user/verification/" + username + "'>Verification</a>"
