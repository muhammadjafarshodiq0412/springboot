...
<!--                                <div class="col-md-2">
                        ...
                        <div class="card-body">
                            <table id="listItem" class="table table-borderless table-striped table-earning">
                                ...
                                <tbody>
                                <c:forEach var = "list" items = "${process_status}" varStatus="loop">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/approve?id=${list.id} " 
                                               class="tombol-approve" data-toogle="tooltip" title="Approve">
                                                Approve
                                            </a>
                                            <a href="/reject?id=${list.id} " 
                                               class="tombol-reject" data-toogle="tooltip" title="Reject">
                                                Reject
                                            </a>
                                        </td>
                                    </tr>
...
<script>
    $('.tombol-reject').on('click', function () {
        event.preventDefault();
        const href = $(this).attr("href");
        swal({
            title: 'Are you sure?',
            text: "Reject this this candidate status apply",
            type: 'warning',
    ...
    $('.tombol-approve').on('click', function () {
        event.preventDefault();
        const href = $(this).attr("href");
        swal({
            title: 'Are you sure?',
            text: "Approve this this candidate status apply",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
