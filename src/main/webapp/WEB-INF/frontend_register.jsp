                ...
                <div class="container">
                    <div class="login-wrap">
                        <div class="login-content">
                            ...
                            <div class="flash-data" data-flashdata="${flash}"> 
                            <div class="message-data" data-message="${message}"> 
                                <script>
...
//                                           }
                                        %>
                                        <input class="au-input au-input--full" type="hidden" id="id" name="id" value="" placeholder="">
                                        <input class="au-input au-input--full" type="text" id="username" name="username" value="" placeholder="Username">
                                    </div>
                                    <div class="form-group">
                                        <% // String mail;
//                                       String cekMail = ${email};
//                                           if (cekMail==null) {
//                                                   mail = "";
//                                               }else{
//                                               mail = cekMail ;
//                                           }
                                        %>
                                        <input class="au-input au-input--full" type="email" id="email" name="email" value="" placeholder="Email">
                                    </div>
                                    <div class="form-group">
